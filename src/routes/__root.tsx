...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Plataforma web para inspeções de Segurança e Saúde no Trabalho (SST).",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/03f81625-730f-47a1-a6f7-647a71ea315e/id-preview-bfdb56fa--c9e79860-055f-475d-97b0-ee0e8eaf0494.lovable.app-1781255272672.png",
      },
      {
        name: "twitter:image",
        content:
