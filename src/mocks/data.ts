import type { Usuario, Empresa, Norma, Checklist, Inspecao, NaoConformidade } from "@/types/sst";

export const usuarios: Usuario[] = [
  {
    id: "u1",
    nome: "Ana Beatriz Lima",
    email: "ana.lima@sstapp.com.br",
    perfil: "inspetor",
    registroProfissional: "TST-12345",
    avatarColor: "oklch(0.62 0.16 152)",
  },
  {
    id: "u2",
    nome: "Carlos Mendes",
    email: "carlos.mendes@sstapp.com.br",
    perfil: "inspetor",
    registroProfissional: "TST-22781",
    avatarColor: "oklch(0.62 0.13 235)",
  },
  {
    id: "u3",
    nome: "Juliana Souza",
    email: "juliana.souza@sstapp.com.br",
    perfil: "gestor",
  ...
  },
  {
    ...
    email: "ricardo.pereira@sstapp.com.br",
    perfil: "auditor",
    registroProfissional: "ENG-89432",
    avatarColor: "oklch(0.58 0.22 27)",
  },
  {
    id: "u5",
    nome: "Fernanda Castro",
    email: "fernanda.castro@sstapp.com.br",
    perfil: "inspetor",
    registroProfissional: "TST-55401",
    avatarColor: "oklch(0.62 0.15 290)",
  },
];
...
export const empresas: Empresa[] = [
  {
    id: "e1",
    razaoSocial: "Metalúrgica Aço Forte Ltda",
  ...
  },
  {
    ...
    nomeFantasia: "Horizonte Obras",
    cnpj: "98765432000155",
    setor: "Construção Civil",
    endereco: "Rua das Obras, 880",
  ...
  {
    id: "e4",
    razaoSocial: "AgroTech Alimentos S/A",
    nomeFantasia: "AgroTech",
    cnpj: "33222111000180",
    setor: "Agroindústria",
    endereco: "Estr. Rural s/n",
    cidade: "Goiânia",
    uf: "GO",
...
export const normas: Norma[] = [
  {
    id: "n1",
    codigo: "NR-1",
    titulo: "Disposições Gerais e GRO",
    descricao: "Estabelece o Gerenciamento de Riscos Ocupacionais (GRO) e o PGR.",
    topicos: ["GRO", "PGR", "Inventário de riscos", "Plano de ação"],
  },
  {
    id: "n5",
    codigo: "NR-5",
    ...
    topicos: ["Composição", "Atribuições", "Treinamento"],
  },
  {
    id: "n6",
    codigo: "NR-6",
    titulo: "Equipamentos de Proteção Individual (EPI)",
    descricao: "Define obrigações sobre fornecimento e uso de EPIs.",
    topicos: ["CA", "Treinamento", "Substituição"],
  },
  {
    id: "n10",
    codigo: "NR-10",
    titulo: "Segurança em Instalações Elétricas",
    descricao: "Requisitos para trabalhos com energia elétrica.",
    topicos: ["Prontuário", "SEP", "Aterramento", "Bloqueio"],
  },
  {
    id: "n12",
    codigo: "NR-12",
    titulo: "Segurança em Máquinas e Equipamentos",
    descricao: "Proteções, dispositivos de segurança e operação segura.",
    topicos: ["Proteções fixas", "Botoeiras", "Manutenção"],
  },
  {
    id: "n17",
    codigo: "NR-17",
    titulo: "Ergonomia",
    descricao: "Adaptação das condições de trabalho às características psicofisiológicas.",
    topicos: ["Mobiliário", "Pausas", "AET"],
  },
  {
    id: "n35",
    codigo: "NR-35",
    titulo: "Trabalho em Altura",
    descricao: "Requisitos mínimos para trabalho em altura acima de 2 m.",
    topicos: ["APR", "PTA", "Cinto", "Resgate"],
  },
];
...
export const checklists: Checklist[] = [
  {
    ...
    secoes: [
      {
        id: "s1",
        titulo: "Fornecimento e Documentação",
        itens: [
          {
            id: "i1",
            texto: "Existe ficha de entrega de EPIs assinada pelos trabalhadores?",
            criticidade: "alta",
            normaRef: "NR-6 6.6.1",
          },
          {
            id: "i2",
            texto: "Todos os EPIs possuem Certificado de Aprovação (CA) válido?",
            criticidade: "critica",
            normaRef: "NR-6 6.2",
          },
          {
            id: "i3",
            texto: "Há controle de substituição periódica dos EPIs?",
            criticidade: "media",
          },
        ],
      },
      {
        id: "s2",
        titulo: "Uso e Conservação",
        itens: [
          {
            id: "i4",
            texto: "Os trabalhadores estão utilizando os EPIs adequados à atividade?",
            criticidade: "critica",
          },
          {
            id: "i5",
            texto: "Os EPIs encontram-se em bom estado de conservação?",
            criticidade: "alta",
          },
  ...
  {
    id: "c2",
    titulo: "Trabalho em Altura - NR-35",
    normaId: "n35",
    versao: "2.0",
    ...
    secoes: [
      {
        ...
        itens: [
          {
            id: "i1",
            texto: "Existe Análise de Risco (APR) específica da atividade?",
            criticidade: "critica",
            normaRef: "NR-35 35.4.5",
          },
      ...
      },
      {
        ...
        itens: [
          {
            id: "i4",
            texto: "Cintos de segurança tipo paraquedista em conformidade e inspecionados?",
            criticidade: "critica",
          },
          { id: "i5", texto: "Pontos de ancoragem certificados e em uso?", criticidade: "critica" },
          {
            id: "i6",
            texto: "Trabalhadores treinados na NR-35 (capacitação válida)?",
            criticidade: "alta",
          },
        ],
      },
  ...
  {
    id: "c3",
    titulo: "Segurança em Máquinas - NR-12",
    normaId: "n12",
    versao: "1.1",
    ...
    secoes: [
      {
        ...
        itens: [
          {
            id: "i1",
            texto: "Zonas de perigo possuem proteção fixa ou móvel adequada?",
            criticidade: "critica",
          },
          { id: "i2", texto: "Botão de emergência acessível e funcional?", criticidade: "critica" },
          {
            id: "i3",
            texto: "Procedimento de bloqueio e etiquetagem (LOTO) implementado?",
            criticidade: "alta",
          },
        ],
      },
...
export const inspecoes: Inspecao[] = [
  {
    id: "ins1",
    codigo: "INS-2026-0142",
    titulo: "Auditoria mensal EPIs - Galpão Usinagem",
    empresaId: "e1",
    unidadeId: "e1u2",
    checklistId: "c1",
    inspetorId: "u1",
    agendadaPara: "2026-06-10T09:00:00",
    iniciadaEm: "2026-06-10T09:12:00",
    concluidaEm: "2026-06-10T11:45:00",
    status: "concluida",
    respostas: {
    ...
    timeline: [
      {
        id: "t1",
        data: "2026-06-09T15:00:00",
        autor: "Juliana Souza",
        descricao: "Inspeção agendada",
      },
      {
        id: "t2",
        data: "2026-06-10T09:12:00",
        autor: "Ana Beatriz Lima",
        descricao: "Inspeção iniciada in loco",
      },
      {
        id: "t3",
        data: "2026-06-10T11:45:00",
        autor: "Ana Beatriz Lima",
        descricao: "Inspeção concluída e assinada",
      },
    ],
  },
  {
    id: "ins2",
    codigo: "INS-2026-0156",
    titulo: "Inspeção trabalho em altura - Obra Vila Verde",
    empresaId: "e2",
    unidadeId: "e2u1",
    checklistId: "c2",
    inspetorId: "u2",
    agendadaPara: "2026-06-12T08:00:00",
    iniciadaEm: "2026-06-12T08:20:00",
    status: "em_andamento",
    respostas: {
      i1: { resposta: "conforme" },
    ...
    timeline: [
      ...
      {
        id: "t2",
        data: "2026-06-12T08:20:00",
        autor: "Carlos Mendes",
        descricao: "Inspeção iniciada",
      },
    ],
  },
  {
    id: "ins3",
    codigo: "INS-2026-0161",
    titulo: "Verificação NR-12 - linha de envase",
    empresaId: "e4",
    unidadeId: "e4u1",
    checklistId: "c3",
    inspetorId: "u5",
    agendadaPara: "2026-06-15T14:00:00",
    status: "planejada",
    respostas: {},
    timeline: [
      {
        id: "t1",
        data: "2026-06-08T11:00:00",
        autor: "Juliana Souza",
        descricao: "Inspeção agendada",
      },
    ],
  ...
  {
    id: "ins4",
    codigo: "INS-2026-0138",
    titulo: "Auditoria EPIs CD Joinville",
    empresaId: "e3",
    unidadeId: "e3u1",
    checklistId: "c1",
    inspetorId: "u1",
    agendadaPara: "2026-06-06T09:00:00",
    iniciadaEm: "2026-06-06T09:05:00",
    status: "pendente_sync",
    respostas: {
      i1: { resposta: "conforme" },
      i2: { resposta: "conforme" },
      i3: { resposta: "conforme" },
      i4: { resposta: "conforme" },
      i5: { resposta: "conforme" },
      i6: { resposta: "conforme" },
    },
    timeline: [
      {
        id: "t1",
        data: "2026-06-06T09:05:00",
        autor: "Ana Beatriz Lima",
        descricao: "Inspeção iniciada offline",
      },
    ],
  },
];
...
export const ncs: NaoConformidade[] = [
  {
    ...
    criticidade: "critica",
    status: "em_tratativa",
    abertaEm: "2026-06-10T11:30:00",
    prazo: "2026-06-20T23:59:00",
    responsavelId: "u3",
    planoAcao: {
    ...
    timeline: [
      {
        id: "t1",
        data: "2026-06-10T11:30:00",
        autor: "Ana Beatriz Lima",
        descricao: "NC registrada durante inspeção",
      },
      {
        id: "t2",
        data: "2026-06-11T09:00:00",
        autor: "Juliana Souza",
        descricao: "Plano de ação 5W2H elaborado",
      },
    ],
  },
  {
    id: "nc2",
    codigo: "NC-2026-0092",
    titulo: "Luvas de raspa danificadas",
    ...
    criticidade: "alta",
    status: "aberta",
    abertaEm: "2026-06-10T11:35:00",
    prazo: "2026-06-17T23:59:00",
    responsavelId: "u3",
    evidencias: ["foto-luvas.jpg"],
    timeline: [
      {
        id: "t1",
        data: "2026-06-10T11:35:00",
        autor: "Ana Beatriz Lima",
  ...
  },
  {
    id: "nc3",
    codigo: "NC-2026-0095",
    titulo: "Permissão de Trabalho vencida",
    ...
    criticidade: "critica",
    status: "aberta",
    abertaEm: "2026-06-12T08:45:00",
    prazo: "2026-06-12T18:00:00",
    responsavelId: "u3",
    evidencias: ["pt-vencida.pdf"],
    timeline: [
      {
        id: "t1",
        data: "2026-06-12T08:45:00",
        autor: "Carlos Mendes",
        descricao: "NC registrada - paralisação imediata da atividade",
      },
    ],
  },
  {
    id: "nc4",
    codigo: "NC-2026-0078",
    titulo: "Falta de plano de resgate em altura",
    ...
    criticidade: "alta",
    status: "resolvida",
    abertaEm: "2026-05-20T10:00:00",
    prazo: "2026-06-05T23:59:00",
    responsavelId: "u4",
    planoAcao: {
    ...
    timeline: [
      ...
      {
        id: "t2",
        data: "2026-06-04T16:00:00",
        autor: "Ricardo Pereira",
        descricao: "Treinamento realizado",
      },
      {
        id: "t3",
        data: "2026-06-05T18:00:00",
        autor: "Ricardo Pereira",
        descricao: "NC resolvida e evidências anexadas",
      },
    ],
  },
  {
    id: "nc5",
    codigo: "NC-2026-0061",
    titulo: "Botão de emergência inoperante",
    ...
    criticidade: "critica",
    status: "vencida",
    abertaEm: "2026-05-01T09:00:00",
    prazo: "2026-05-15T23:59:00",
    responsavelId: "u3",
    evidencias: [],
    timeline: [
      {
        id: "t1",
        data: "2026-05-01T09:00:00",
